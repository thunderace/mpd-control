...
import org.chatminou.mpdcontrol.mpd.exception.MPDClientException;
import org.chatminou.mpdcontrol.mpd.exception.MPDConnectionException;
    ...
    public List<Item> getPlaylists(boolean sort) throws MPDServerException 
    {
        ...
        for (String line : response) 
        {
            if (line.startsWith("playlist"))
            {
            	...
            	if (name.equalsIgnoreCase("Radios")) continue;
            	tmpResult.add(new Playlist(name));
            }
        }
        ...
        result.add(new Playlist("Radios"));
