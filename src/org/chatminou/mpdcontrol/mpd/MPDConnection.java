...
import org.chatminou.mpdcontrol.mpd.exception.MPDNoResponseException;
        ...
        public MPDCommandResult call() throws Exception {
            ...
            while (result.getResult() == null && retry < MAX_REQUEST_RETRY && !cancelled
                ...
                try {
                	...
                	{
                		result.setLastexception(new MPDConnectionException( (ex1 == null) ? "Invalid password" : ex1.getMessage() ));
                		return result;
                	}
                	else 
